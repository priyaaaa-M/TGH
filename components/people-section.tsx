...
const teamMembers = [
  ...
  {
    name: "Coming Soon",
    role: "Filmmaker / Creative Practitioner",
    quote: "“Stories change shape when people feel safe enough to tell them.”",
    image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400&h=500&fit=crop",
    bgColor: "bg-gray-50",
    tapeColor: "rgba(200,200,200,0.65)",
    tapeAngle: 4,
    rotation: 3,
    doodle: "📸",
    doodleColor: "text-gray-400",
  },
  {
    name: "Coming Soon",
    role: "Emotional Safety Lead",
