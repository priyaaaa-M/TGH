...
const teamMembers = [
  {
    ...
    image: "/profile_pic/dipti_shah.png",
    bgColor: "bg-[#EDE0FF]",
  ...
  },
  {
    ...
    image: "/profile_pic/dimple_jogani.png",
    bgColor: "bg-[#FFE8D8]",
  ...
  },
  {
    ...
    image: "/profile_pic/sourabh_bagree.png",
    bgColor: "bg-[#E8F5E8]",
  ...
  },
  {
    ...
    image: "/profile_pic/priyanka_mandal.png",
    bgColor: "bg-[#F0F4FF]",
  ...
  },
  {
    name: "Neena",
    role: "Storyteller",
    quote: "Tum Bhi Chalo, Hum Bhi Chalein, Chalti Rahe Zindagi.",
    image: "/profile_pic/Neena  .png",
    bgColor: "bg-[#FFF9E8]",
  ...
  },
  {
    name: "Shalina",
    role: "Storyteller",
    quote: "You don’t have to be the best in the world, you just have to be better than yesterday.",
    image: "/profile_pic/Shalina.png",
    bgColor: "bg-[#EDE0FF]",
    tapeColor: "rgba(230,170,220,0.65)",
    tapeAngle: -2,
    rotation: -1,
  ...
  {
    name: "Krishna Bhatt Sarda",
    role: "Storyteller",
    quote: "There is always light at the end of the tunnel, you just have to walk towards it.",
    image: "/profile_pic/Krishna .png",
    bgColor: "bg-[#FFE8D8]",
    tapeColor: "rgba(255,190,150,0.65)",
    tapeAngle: -4,
    rotation: -3,
  ...
  {
    name: "Priyanka Sagar Maheshwari",
    role: "Storyteller",
    quote: "You haven’t come this far to only come this far.",
    image: "/profile_pic/Priyanka Storyteller.png",
    bgColor: "bg-[#E8F5E8]",
    tapeColor: "rgba(130,200,180,0.65)",
    tapeAngle: 2,
    rotation: 2,
  ...
  },
  {
    ...
    image: "/profile_pic/Janki Chotalia .png",
    bgColor: "bg-[#F0F4FF]",
    tapeColor: "rgba(190,210,255,0.65)",
    tapeAngle: 3,
    rotation: 1,
  ...
  {
    name: "Achint Kaur Anand",
    role: "Counsellor",
    quote: "Know all the theories, master all the techniques, but as you touch a human soul be just another human soul.",
    image: "/profile_pic/Achint Kaur Anand.png",
    bgColor: "bg-[#FFF9E8]",
    tapeColor: "rgba(250,220,60,0.65)",
    tapeAngle: -3,
    rotation: -2,
