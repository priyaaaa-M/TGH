...
export default function VoicesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F8F4EE] selection:bg-lavender selection:text-foreground pb-20">
      <Navbar />
      ...
      <section className="pt-32 pb-10 md:pt-40 md:pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-foreground">
            Unfiltered
            <span className="font-handwritten text-sage-green font-normal block mt-2 text-5xl md:text-7xl -rotate-2">
              voices.
            </span>
          </h1>
          <p className="text-lg text-foreground/70 font-medium max-w-xl mx-auto pt-4">
            Listen to the unspoken thoughts of our community. Share your own anonymously. This is a safe space for radical honesty.
          </p>
        </div>
      </section>
