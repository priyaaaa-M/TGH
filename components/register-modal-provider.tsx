...
export const FORM_URL = "https://docs.google.com/forms/d/1ZSUlQS2k2gWhYY2oZmEOwRshBHK-Ml_tfNpdBm17cJk/edit?utm"
        ...
        {isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-[#F8F4EE] rounded-[2rem] p-6 sm:p-10 md:p-12 shadow-soft-lg border-4 border-foreground overflow-hidden z-50 my-8 mx-auto"
            >
              ...
              <div className="absolute top-4 left-1/2 -translate-x-1/2 w-32 h-8 bg-[#FFD86B] -rotate-2 shadow-sm z-20 flex items-center justify-center border border-foreground/10">
                <span className="font-handwritten text-foreground text-sm font-black tracking-widest">UNFILTERED</span>
              </div>
              ...
              <div className="relative mt-4 space-y-6 text-center md:text-left">
                ...
                <div className="space-y-4 text-sm sm:text-base md:text-lg leading-relaxed text-foreground/85 font-medium font-sans">
                  ...
                  {/* Bullet points scrapbook style card */}
